...
import cn.mybatisdemo.login.entity.Permissions;
import cn.mybatisdemo.login.entity.Role;
...
/**
 * @Description : 自定义认证校验
 * @Author : lizhikang@youngyedu.com, 2020/4/16 11:07
...
public class CustomRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        loginService.findRoleAndPermissions(user);
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        for(Role role:userInfo.getRoles()){
            ...
            for(Permissions p:role.getPermissions()){
                authorizationInfo.addStringPermission(p.getPermissionsName());
            }
        }
